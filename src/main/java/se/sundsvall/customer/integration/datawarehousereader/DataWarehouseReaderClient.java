...
public interface DataWarehouseReaderClient {
	...
	@GetMapping(path = "/{municipalityId}/customer/engagements", produces = APPLICATION_JSON_VALUE)
	CustomerEngagementResponse getCustomerEngagement(
		@PathVariable("municipalityId") String municipalityId,
		@RequestParam(value = "partyId") String partyId);

	@GetMapping(path = "/{municipalityId}/customer/details", produces = APPLICATION_JSON_VALUE)
